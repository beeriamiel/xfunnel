...
export default function AiButton({ onClick, disabled, children }: AiButtonProps) {
  ...
  return (
    <button
      onClick={onClick}
      disabled={disabled}
      className="group relative rounded-full bg-gradient-to-r from-blue-300/30 via-blue-500/30 via-40% to-purple-500/30 p-1 text-white transition-transform hover:scale-110 active:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
    ...
    >
      <div className="relative flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-blue-300 via-blue-500 via-40% to-purple-500 px-4 py-2 text-white">
        ...
        {children || <span className="font-semibold">Magic Keyword Generator</span>}
      </div>
      {!!particleState && (
        <Particles
          id="magic-particles"
