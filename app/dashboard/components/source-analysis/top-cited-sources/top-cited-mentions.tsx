...
import { TopCitedSource, TopCitedSourcesProps, MENTION_PHASES, GroupedCitation } from './types'
...
export const TopCitedMentions = memo(function TopCitedMentions({ 
  companyId 
  ...
  if (topSources.length === 0) {
    return (
      <div className="text-center py-8 text-muted-foreground">
        No citations found for mentions analysis
      </div>
    )
  }
