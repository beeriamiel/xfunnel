...
function QueryGeneration({ icps, personas }: { icps: ICP[], personas: Persona[] }) {
  ...
  const handleGenerateQueries = () => {
    ...
    setTimeout(() => {
      // Generate mock queries based on selected ICP and persona
      const mockQueries: Query[] = [
        {
          id: crypto.randomUUID(),
          text: `What are the key challenges in ${selectedICP.vertical} for ${selectedPersona.title}s?`,
          status: 'complete',
          createdAt: new Date()
        },
        {
          id: crypto.randomUUID(),
          text: `How does ${selectedPersona.title} evaluate new solutions in ${selectedICP.vertical}?`,
          status: 'complete',
          createdAt: new Date()
        },
        {
          id: crypto.randomUUID(),
          text: `What are the main pain points for ${selectedPersona.title}s in ${selectedICP.companySize} companies?`,
          status: 'complete',
          createdAt: new Date()
        }
      ]
