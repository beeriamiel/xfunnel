...
import { PHASE_ORDER, PHASE_LABELS } from "../../types/query-types"
...
export function Queries({ 
  ...
  // Calculate totals
  const totalResponses = data.reduce((total: number, phase) => {
    return total + phase.queries.reduce((sum: number, query) => {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-4">
          <Badge variant="secondary" className="text-sm">
            {data.reduce((sum: number, phase) => sum + phase.queries.length, 0)} queries
          </Badge>
          <Badge variant="secondary" className="text-sm">
      ...
      <div className="space-y-4">
        {PHASE_ORDER.map((phase, index) => {
          const phaseData = data.find(p => p.stage === phase)
              ...
              >
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                      <QueryCount 
                        count={phaseData.queries.reduce((sum: number, query) => 
