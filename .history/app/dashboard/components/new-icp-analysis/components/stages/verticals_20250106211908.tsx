...
type MetricKey = 'sentimentScore' | 'rankingPosition' | 'companyMentioned' | 'featureScore'
...
export function Verticals({ companyId, selectedRegion, onSelectVertical, onBack }: VerticalsProps) {
  ...
  const { data, error, isLoading } = useSWR(
    companyId && selectedRegion ? `vertical-analysis-${companyId}-${selectedRegion}` : null,
    () => companyId && selectedRegion ? getAnalysisByVertical(companyId, selectedRegion) : null
  )
