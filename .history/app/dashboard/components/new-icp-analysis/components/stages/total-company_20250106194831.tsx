...
import { Brain, Target, Building2, ThumbsUp, ChevronRight, AlertCircle } from "lucide-react"
...
export function TotalCompany({ companyId }: TotalCompanyProps) {
  ...
  const { data, error, isLoading } = useSWR(
    companyId ? `company-analysis-${companyId}` : null,
    () => companyId ? getAnalysisByCompany(companyId) : null
  )
