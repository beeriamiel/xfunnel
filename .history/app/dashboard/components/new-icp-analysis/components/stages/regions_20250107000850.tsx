      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-4 space-y-4">
          ...
          <div className="flex items-center gap-4">
            <h3 className="text-sm font-medium text-muted-foreground whitespace-nowrap">Time Period</h3>
            <div className="bg-muted/10 p-1 rounded-lg flex items-center flex-1">
              <button
