      ...
      },
      {
        ...
        timeline: Array.from({ length: 12 }, (_, i) => ({
          ...
          metrics: {
            ...
            recommendation_probability: 75 + Math.random() * 10
          }
        }))
      }
    ],
    "Financial Services": [
      {
        ...
        timeline: Array.from({ length: 12 }, (_, i) => ({
          ...
          metrics: {
            ...
            company_mentioned: 65 + Math.random() * 15,
            recommendation_probability: 70 + Math.random() * 15
          }
        }))
      }
    ],
      ...
      problem_exploration: [
        {
          ...
          timeline: Array.from({ length: 12 }, (_, i) => ({
            ...
            metrics: {
              ...
              company_mentioned: 75 + Math.random() * 10,
              recommendation_probability: 85 + Math.random() * 10
            }
          }))
        }
      ],
      ...
      solution_comparison: [
        {
          ...
          timeline: Array.from({ length: 12 }, (_, i) => ({
            ...
            metrics: {
              ...
              recommendation_probability: 75 + Math.random() * 15
            }
          }))
        }
      ],
