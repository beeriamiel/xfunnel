            ...
            {step === 'product' && !isLoading && (
              <Card className="w-full max-w-xl p-4">
                <div className="space-y-4">
                  ...
                  <div className="space-y-4 border rounded-lg p-3 bg-[#f6efff]/20">
                    <p className="text-sm text-muted-foreground">Add a new product:</p>
                    <div className="flex gap-3">
                      <div className="flex-1">
                        <Label className="text-xs mb-1.5 after:content-['*'] after:text-red-500 after:ml-0.5">
                          Product name
                        </Label>
                        <Input
                    ...
                    <Button
                      ...
                      className="bg-[#30035e] hover:bg-[#30035e]/90 w-full"
                      size="sm"
                  ...
                  <div className="min-h-[100px] max-h-[300px] overflow-y-auto">
                    <div className="grid gap-2">
                      ...
                      {products.length === 0 && (
                        <div className="flex items-center justify-center h-[100px] text-sm text-muted-foreground border border-dashed rounded-md">
