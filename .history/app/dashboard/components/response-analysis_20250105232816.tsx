...
interface SelectableCardProps extends BaseSelectableCardProps {
  icon: React.ElementType; // Override LucideIcon with React.ElementType
}
...
function generateMockQueries(vertical: string, title: string): SimpleQuery[] {
  return [
    {
                    ...
                    <TableCell colSpan={8}>
                      <div className="py-4 px-6 bg-[#f6efff]/50 space-y-4">
                        <ScrollArea className="h-[200px] rounded-md border border-[#f9a8c9]/20 bg-white">
                          <div className="p-4 space-y-3">
                            {combination.queries.map((query: SimpleQuery) => (
                              <div 
                                key={query.id}
