...
function generateMockQueries(vertical: string, title: string): { id: string; text: string; status: 'pending' | 'analyzing' | 'complete' }[] {
  return [
    {
      id: crypto.randomUUID(),
...
function CompanySetup({ onComplete, onTransitionStart, setShowSuccessAnimation, setIsTransitioning, setHasCompletedOnboarding, setCompanyProfile }: CompanySetupProps) {
                    ...
                    <TableCell colSpan={8}>
                      <div className="py-4 px-6 bg-[#f6efff]/50 space-y-4">
                        <ScrollArea className="h-[200px] rounded-md border border-[#f9a8c9]/20 bg-white">
                          <div className="p-4 space-y-3">
                            {combination.queries.map((query: { id: string; text: string; status: 'pending' | 'analyzing' | 'complete' }) => (
                              <div 
                                key={query.id}
