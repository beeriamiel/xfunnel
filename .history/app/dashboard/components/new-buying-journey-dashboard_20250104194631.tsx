      ...
      try {
        ...
        const processedQueries = (queryData || [])
          .filter((q): q is {
            ...
            const query = q as RawQueryData
            return query.query_id !== null &&
              query.query_text !== null &&
              query.buying_journey_stage !== null &&
              typeof query.query_id === 'number' &&
              typeof query.query_text === 'string' &&
              typeof query.buying_journey_stage === 'string'
          })
          .map(queryInfo => {
            ...
            const queryResponses = (responseData || [])
              .filter((r): r is {
                ...
                const response = r as RawResponseData
                return response.query_id !== null &&
                  response.company_mentioned !== null &&
                  response.buyer_persona !== null &&
                  response.buying_journey_stage !== null &&
                  response.answer_engine !== null &&
                  response.mentioned_companies !== null &&
                  typeof response.query_id === 'number' &&
                  typeof response.company_mentioned === 'boolean' &&
                  typeof response.buyer_persona === 'string' &&
                  typeof response.buying_journey_stage === 'string' &&
                  typeof response.answer_engine === 'string' &&
                  (response.sentiment_score === null || typeof response.sentiment_score === 'number') &&
                  (response.ranking_position === null || typeof response.ranking_position === 'number') &&
                  (response.rank_list === null || typeof response.rank_list === 'string') &&
                  (response.response_text === null || typeof response.response_text === 'string') &&
                  typeof response.recommended === 'boolean' &&
                  Array.isArray(response.mentioned_companies) &&
                  response.query_id === queryInfo.query_id
              })
