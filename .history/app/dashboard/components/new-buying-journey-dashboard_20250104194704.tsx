...
// Update interfaces to use non-null types
...
// Update type guards to ensure non-null values
      ...
      try {
        ...
        const processedQueries = (queryData || [])
          .filter((q): q is {
            ...
            const maybeQuery = q as unknown as {
              query_id?: number | null;
              query_text?: string | null;
              buying_journey_stage?: string | null;
              company_name?: string | null;
            }
            return maybeQuery.query_id !== null &&
              maybeQuery.query_text !== null &&
              maybeQuery.buying_journey_stage !== null &&
              typeof maybeQuery.query_id === 'number' &&
              typeof maybeQuery.query_text === 'string' &&
              typeof maybeQuery.buying_journey_stage === 'string'
          })
          .map(queryInfo => {
            ...
            const queryResponses = (responseData || [])
              .filter((r): r is {
                ...
                const maybeResponse = r as unknown as {
                  query_id?: number | null;
                  sentiment_score?: number | null;
                  ranking_position?: number | null;
                  company_mentioned?: boolean | null;
                ...
                return maybeResponse.query_id !== null &&
                  maybeResponse.company_mentioned !== null &&
                  maybeResponse.buyer_persona !== null &&
                  maybeResponse.buying_journey_stage !== null &&
                  maybeResponse.answer_engine !== null &&
                  maybeResponse.mentioned_companies !== null &&
                  typeof maybeResponse.query_id === 'number' &&
                  typeof maybeResponse.company_mentioned === 'boolean' &&
                  typeof maybeResponse.buyer_persona === 'string' &&
                  typeof maybeResponse.buying_journey_stage === 'string' &&
                  typeof maybeResponse.answer_engine === 'string' &&
                  (maybeResponse.sentiment_score === null || typeof maybeResponse.sentiment_score === 'number') &&
                  (maybeResponse.ranking_position === null || typeof maybeResponse.ranking_position === 'number') &&
                  (maybeResponse.rank_list === null || typeof maybeResponse.rank_list === 'string') &&
                  (maybeResponse.response_text === null || typeof maybeResponse.response_text === 'string') &&
                  typeof maybeResponse.recommended === 'boolean' &&
                  Array.isArray(maybeResponse.mentioned_companies) &&
                  maybeResponse.query_id === queryInfo.query_id
              })
