  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        ...
        Object.values(engineData).forEach(engineMetrics => {
          const totalMentions = engineMetrics.mentions.reduce((sum, item) => sum + item.mentions.count, 0);
          engineMetrics.mentions.forEach(item => {
