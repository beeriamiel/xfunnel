      ...
      <div className="flex justify-center gap-20 mb-8">
        <div className="text-center">
          <div className="flex items-center justify-center gap-1 mb-1">
            ...
            <span className="text-lg font-medium">{companyData.main_products.length}</span>
          </div>
        ...
        <div className="text-center">
          <div className="flex items-center justify-center gap-1 mb-1">
            ...
            <span className="text-lg font-medium">{companyData.markets_operating_in.length}</span>
          </div>
        ...
        <div className="text-center">
          <div className="flex items-center justify-center gap-1 mb-1">
            ...
            <span className="text-lg font-medium">{companyProfile?.icps?.length || 0}</span>
          </div>
        ...
        <div className="text-center">
          <div className="flex items-center justify-center gap-1 mb-1">
            ...
            <span className="text-lg font-medium">{companyProfile?.personas?.length || 0}</span>
          </div>
