    ...
    <Card className="p-4">
      ...
      <div className="space-y-3">
        <div className="flex items-center">
          <Building2 className="h-5 w-5 text-purple-700 mr-2" />
      ...
      <div className="space-y-3 mt-4">
        <div>
          <h3 className="text-xs font-medium uppercase text-gray-500 mb-1.5">Products</h3>
        ...
        <div>
          <h3 className="text-xs font-medium uppercase text-gray-500 mb-1.5">Markets</h3>
          <div className="flex flex-wrap gap-1.5">
