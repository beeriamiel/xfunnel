      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead>Feature Score</TableHead>
                ...
                return (
                  <React.Fragment key={persona.id}>
                    <TableRow className="group">
                      ...
                      <TableCell>{personaStats?.companyMentioned || '4%'}</TableCell>
                      <TableCell>{personaStats?.averagePosition || '1.0'}</TableCell>
                      <TableCell>{personaStats?.featureScore || '0%'}</TableCell>
                      <TableCell>{personaStats?.averageSentiment || '0%'}</TableCell>
                      <TableCell>
                        {isLoadingStats ? (
