                ...
                return (
                  <React.Fragment key={persona.id}>
                    <TableRow className="group">
                      ...
                      <TableCell>{personaStats?.companyMentioned || '-'}</TableCell>
                      <TableCell>{personaStats?.averagePosition || '-'}</TableCell>
                      <TableCell>{personaStats?.featureScore || '-'}</TableCell>
                      <TableCell>{personaStats?.averageSentiment || '-'}</TableCell>
                      <TableCell>
                        {isLoadingStats ? (
