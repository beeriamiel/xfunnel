...
function getLatestResponseInfo(queries: Query[]) {
  ...
  console.log('Queries with responses:', queries.filter(q => q.responses?.length));
  ...
  for (const query of queries) {
    ...
    if (latestResponse?.created_at) {
      console.log('Found response with date:', latestResponse.created_at, 'for query:', query.id);
      totalResponses++;
