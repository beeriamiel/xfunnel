    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <div className="flex items-center justify-between px-3 py-1.5 hover:bg-gray-50 min-h-[36px]">
...
function PhaseGroup({ phase, queries }: { phase: string; queries: Query[] }) {
  ...
  return (
    <div>
      <div className="sticky top-0 bg-gray-50 px-3 py-2 border-y flex items-center justify-between min-h-[40px]">
        <div>
...
export function ExpandedQueryRow({ queries, onGenerateResponse }: ExpandedQueryRowProps) {
  ...
  return (
    <div className="border-t">
      ...
      <div className="px-3 py-2 border-t bg-white flex items-center justify-between min-h-[48px]">
