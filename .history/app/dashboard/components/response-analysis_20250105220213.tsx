...
function adaptStoreICP(icp: StoreICP): ICP {
  return {
    id: icp.id,
    region: icp.region,
...
function adaptStorePerson(persona: StorePersona): Persona {
  return {
    id: persona.id,
    title: persona.title,
...
function adaptToStoreICP(icp: ICP): StoreICP {
  return {
    id: icp.id,
    region: icp.region,
    vertical: icp.vertical,
...
function adaptToStorePerson(persona: Persona): StorePersona {
  return {
    id: persona.id,
    title: persona.title,
