  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <Button
            onClick={() => onGenerateQuestions(selectedRows)}
          ...
          <TableBody>
            {combinations.map((combination) => (
              <TableRow key={combination.id}>
                ...
                <TableCell className="text-right">{combination.questions}</TableCell>
                <TableCell className="text-right">{combination.responses}</TableCell>
                <TableCell className="text-right">
                  {combination.lastUpdated ? combination.lastUpdated : 'Never'}
                </TableCell>
              </TableRow>
            ))}
