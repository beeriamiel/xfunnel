    ...
    const loadCompanyData = async () => {
      ...
      try {
        const [
          ...
          supabase.from('companies').select('*').eq('id', finalCompanyId).single(),
          supabase.from('competitors').select('*').eq('company_id', finalCompanyId),
          supabase.from('ideal_customer_profiles').select('*').eq('company_id', finalCompanyId),
