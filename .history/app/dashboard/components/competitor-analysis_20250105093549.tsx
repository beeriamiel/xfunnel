  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        ...
        // Calculate percentages for mentions and sort data
        ...
        Object.entries(engineData).forEach(([currentEngine, data]) => {
          ...
          const totalMentions = data.mentions.reduce((sum: number, item: CompetitorData) => sum + item.mentions.count, 0);
          data.mentions.forEach((item: CompetitorData) => {
