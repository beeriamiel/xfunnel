...
export function PersonaView() {
  ...
  useEffect(() => {
    async function loadQueries() {
      if (!selectedRegion || !selectedVertical || !selectedPersona || !selectedCompanyId) return
      
      setIsLoading(true)
      try {
        const data = await fetchQueries(selectedCompanyId, selectedPersona, {
          type: filterType,
    ...
    loadQueries()
  }, [selectedRegion, selectedVertical, selectedPersona, filterType, selectedBatchId, selectedTimePeriod, selectedCompanyId])
